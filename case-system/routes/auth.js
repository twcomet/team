...
router.get('/me', (req, res) => {
  ...
  const fresh = db.prepare(`SELECT can_see_amounts, can_see_cost, can_see_labor_cost, can_manage_assets, can_delete, can_ship, is_manager, permissions FROM users WHERE id=?`).get(req.session.user.id);
  if (fresh) {
