...
if (!db.prepare(`SELECT 1 FROM cs_knowledge WHERE keywords='__kbpack_v1__'`).get()) {
  ...
  kp.run('公司資訊', '你們是做什麼的？', '繪新國際是專業的裝潢貼膜公司，提供牆面、系統櫃門片、造型、玻璃、電梯、天花板等貼膜施工，讓空間換上新面貌 😊', '', '', '公司,做什麼,服務,貼膜,介紹', 5);
  kp.run('服務範圍', '有到府施工嗎／服務地區？', '我們有到府丈量與施工服務～您方便提供施工地點嗎？我幫您確認能不能安排喔！（實際服務範圍以客服確認為準）', '', '', '到府,施工,地區,範圍,服務', 30);
  kp.run('材質', '有哪些膜料品牌／花色？', '我們主要使用韓國膜（BODAQ／BENIF）、PAROI、3M 等品牌，花色有木紋、石紋、皮革、亮面、金屬、素面等，也有防焰款可選 😊要不要我依您的空間幫您推薦？', '', '', '品牌,花色,材質,防焰,BODAQ,BENIF,PAROI,3M', 35);
  kp.run('報價', '怎麼報價／費用怎麼算？', '費用會依施工位置、面積與材質而定，通常需要現場丈量後由專人為您報價喔～可以先傳幾張照片和大概尺寸，我們幫您做初步評估！', '', '', '報價,費用,價格,多少錢,估價', 40);
  kp.run('展間', '可以參觀展間嗎？', '可以喔！我們有實體展間，能看到實際材質與貼膜效果，很歡迎您預約參觀～（展間地址與可參觀時段請客服提供）', '', '', '展間,參觀,看樣品,實體', 45);
  kp.run('自媒體／影片', '有沒有作品或教學影片可以看？', '有的！我們在 YouTube、Instagram、Facebook、TikTok、小紅書 都有分享實際案例短影音，您可以參考看看～需要的話我幫您找對應主題的影片！（各連結陸續建置中）', '', '', '影片,作品,案例,短影音,youtube,ig,tiktok,小紅書', 50);
  kp.run('保固／售後', '有保固嗎？', '關於保固與售後服務的細節，我幫您轉由專人為您完整說明，好嗎？😊（保固條件以客服/合約為準）', '', '', '保固,售後,維修,保障', 60);
}
